...
async function verifyToken(request) {
    ...
    const empId = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$redis$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].get(`token:${token}`);
    return empId || null;
}
}),
"[project]/app/api/admin/stats/reset/route.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {

const e = new Error("Could not parse module '[project]/app/api/admin/stats/reset/route.js', file not found");
e.code = 'MODULE_UNPARSABLE';
throw e;
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__0kptvt.._.js.map